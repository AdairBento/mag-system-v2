...
Write-Host ""
Write-Host "📝 Comando rápido para gerar bugpack:" -ForegroundColor Cyan
Write-Host ".\scripts\debug\Generate-Bugpack.ps1 -ApiPath `"apps\api\src\modules\clients`" -Search `"ClientDto,findAll`"" -ForegroundColor White
