...
describe('AuthService', () => {
  ...
  describe('logout', () => {
    it('should revoke refresh token and log', async () => {
      ...
      expect(mockRefreshTokenService.revokeRefreshToken).toHaveBeenCalledWith('refresh-token');
  ...
  describe('refreshAccessToken', () => {
    it('should refresh access token', async () => {
      ...
      const result = await service.refreshAccessToken('refresh-token', '127.0.0.1', 'test-agent');
