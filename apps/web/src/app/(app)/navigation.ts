...
export const menu: (NavGroup | NavItem)[] = [
  ...
  { type: 'item', name: 'Motoristas', href: '/motoristas', icon: Truck },
  { type: 'group', label: 'Operação de locação' },
  { type: 'item', name: 'Locações', href: '/locacoes', icon: FileText },
  { type: 'item', name: 'Contratos', href: '/contratos', icon: FilePen },
  ...
  { type: 'item', name: 'Notificações', href: '/notificacoes', icon: Bell },
  { type: 'item', name: 'Fila de Jobs', href: '/fila', icon: ListOrdered },
...
export const iconColors: Record<string, string> = {
  ...
  '/notificacoes': 'text-pink-300',
  '/fila': 'text-fuchsia-300',
